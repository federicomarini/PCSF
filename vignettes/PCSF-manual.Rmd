...
vignette: >
  %\VignetteIndexEntry{The PCSF Package}
  %\VignetteEncoding{UTF-8}  
  %\VignettePackage{PCSF}
  %\VignetteKeywords{GeneExpression, Transcriptomics, Visualization,
    DifferentialExpression, Pathways, GeneSetEnrichment, NetworkEnrichment,
    Network, RNASeq, FunctionalAnnotation, Sequencing, Visualization}
